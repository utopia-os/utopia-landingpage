...
export const LanguageController = () => {
    ...
    return (
        <details className="dropdown">
            <summary className="btn btn-ghost btn-sm m-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
